...
1. 打开Microsoft Visual Studio（以下简称VS）后，点击“新建”->“项目”
   ...
   ![1678695867359](AI五子棋.assets/1678695867359.png)

2. 然后输入项目名称与项目位置，然后点击“确定”

   ![1678696426899](AI五子棋.assets/1678696426899.png)

# 二、导入素材

1. 在项目内新建“resource”文件夹，准备存放项目的素材文件

   ![1678949322226](AI五子棋.assets/1678949322226.png)

2. 将项目所用素材导入项目中的“resource”文件夹中，读者可以用自己的素材，也可以用我的素材，我的素材的下载链接已经放在上面的博客中了

   ![1678949369436](AI五子棋.assets/1678949369436.png)
...
1. 整个项目的框架如下图所示，所有的代码都是根据以下四个类进行编写的：
   ...
   ![1678775271221](AI五子棋.assets/1678775271221.png)
...
1. 根据刚才设计好的项目框架，我们就要将其一一建立起来。首先创建Man（棋手）类，在“源文件”上右键，点击“添加”中的“类”：
   ...
   ![1678775692863](AI五子棋.assets/1678775692863.png)

2. 在“类名”中输入“Man”，点击“确定”就可以了，其余的文件自动生成

   ![1678775760089](AI五子棋.assets/1678775760089.png)

3. 可以发现，已经成功生成了

   ![1678775842356](AI五子棋.assets/1678775842356.png)

4. 按照创建Man（棋手）类同样的方法，创建其他三个类，最终效果如下图所示：

   ![1678776225162](AI五子棋.assets/1678776225162.png)
...
3. 此时就完成了整个游戏的基本框架，下面我们就要往这个框架中添加具体内容了。当然，在这之前我们还需要使用一个主函数将刚刚创建的框架串联起来。首先创建main.cpp，这里面就是游戏的整体逻辑，具体内容后面再写，在“源文件”上右键，选择“添加”->“新建项”：
   ...
   ![1678862785090](AI五子棋.assets/1678862785090.png)

4. 选择C++文件(.cpp)后输入名字，最后点击“添加”即可

   ![1678862825037](AI五子棋.assets/1678862825037.png)
...
6. 此时我们可以运行测试一下，点击“调试”中的“开始执行(不调试)(H)”：
   ...
   ![1678868499271](AI五子棋.assets/1678868499271.png)

7. 可以发现到目前为止，我们的程序没有问题：

   ![1678868258360](AI五子棋.assets/1678868258360.png)
...
1. 因为游戏要进行绘图，所以我们使用EasyX来完成游戏的绘图接口，可以帮助我们编写图形程序，EasyX的下载链接也在博客的上方。下载后双击打开：
   ...
   ![1678864006491](AI五子棋.assets/1678864006491.png)

2. 点击“下一步”：

   ![1678864022792](AI五子棋.assets/1678864022792.png)

3. 然后选择你对应版本的编译器进行“安装”：

   ![1678864055489](AI五子棋.assets/1678864055489.png)

4. 然后会提示你安装成功：

   ![1678864076024](AI五子棋.assets/1678864076024.png)

## 6.2 设计棋盘的数据成员

1. 当我们安装好EasyX图形库后，就要在Chess.h中引入一些我们所需要的头文件了：

   ![1678864194185](AI五子棋.assets/1678864194185.png)
...
2. 然后鼠标放在刚刚创建的函数上，点击“显示可能的修补程序”：
   ...
   ![1678865776924](AI五子棋.assets/1678865776924.png)

3. 然后选择红框中的内容：

   ![1678865854493](AI五子棋.assets/1678865854493.png)

4. 然后按“Ctrl+S”保存

   ![1678865922956](AI五子棋.assets/1678865922956.png)
...
6. 然后来到main.cpp中，使用我们刚刚创建的构造函数，传入参数就构造好棋盘了
   ...
   ![1678867216187](AI五子棋.assets/1678867216187.png)

7. 然后我们还是来测试一下，点击“调试”中的“开始执行(不调试)(H)”：

   ![1678868467074](AI五子棋.assets/1678868467074.png)

8. 可以发现，到目前为止，我们的程序没有任何问题：

   ![1678868424292](AI五子棋.assets/1678868424292.png)

## 6.4 棋盘初始化

1. 在项目上右键后，点击“属性”：

   ![1678949967724](AI五子棋.assets/1678949967724.png)

2. 在“常规”的“字符集”中，选择“使用多字节字符集”：

   ![1678949998648](AI五子棋.assets/1678949998648.png)
...
5. 然后我们测试一下：
   ...
   ![1678950157109](AI五子棋.assets/1678950157109.png)

6. 发现已经成功显示棋盘，并成功播放音乐了：

   ![1678950202186](AI五子棋.assets/1678950202186.png)
...
1. 下棋最重要的一点就是让计算机知道棋下在了哪里，如何解决这个问题呢？我们可以看下面的图示：
   ...
   ![1678979438754](AI五子棋.assets/1678979438754.png)
...
3. 此时就可以判断落子的位置是否有效了，为了验证我们的代码没有问题，我们需要验证一下，我们在Chess.cpp中加入如下代码，测试成功后可以删除加入的代码：
   ...
   ![1678980096334](AI五子棋.assets/1678980096334.png)

4. 在Man.cpp中加入如下代码，打印落子位置，同样，测试成功之后也可以删除加入的代码：

   ![1678980160901](AI五子棋.assets/1678980160901.png)

5. 此时我们就可以来到main.cpp中进行测试了：

   ![1678980482241](AI五子棋.assets/1678980482241.png)

6. 可以发现正确获取落子位置了，这说明我们的代码没有任何问题。测试成功之后，要把上面加的两处代码删掉：

   ![1678980603201](AI五子棋.assets/1678980603201.png)
...
2. 然后我们来测试一下，发现可以成功落子，而且音效也没问题，但是每个棋子周围都有黑边，这些黑边肯定是不应该存在的：
   ...
   ![1679022596467](AI五子棋.assets/1679022596467.png)
...
4. 然后修改Chess.cpp中的Chess::chessDown函数为如下图示：
   ...
   ![1679022374559](AI五子棋.assets/1679022374559.png)

5. 此时我们再来测试一下，可以发现黑边没有了，音效也没问题：

   ![1679022639640](AI五子棋.assets/1679022639640.png)
...
8. 然后在Chess.cpp中的Chess::chessDown函数中调用Chess::updateGameMap：
   ...
   ![1679029115805](AI五子棋.assets/1679029115805.png)
...
2. 对于AI来说，每一次落子后，此落子周围共有八个方向，对于每一个落子点，应该向该点的八个方向分别进行评分计算，评分计算的标准就是确定每个方向已经有几颗连续的棋子了。假设现在有一个可能的落子点如下图黑点所示：
   ...
   ![1679044675994](AI五子棋.assets/1679044675994.png)
...
4. 既然要根据连续的黑棋或者白棋数量进行价值的评判，所以我们应该对五子棋中常见的棋形有一个基本的了解，这样有助于我们对不同的情况进行价值的评判。五子棋中的常见棋形如下所示：
   ...
   - 连二：
     ...
     |                     第一种情况                      |                     第二种情况                      |
     | :-------------------------------------------------: | :-------------------------------------------------: |
     | ![1679045230206](AI五子棋.assets/1679045230206.png) | ![1679045250795](AI五子棋.assets/1679045250795.png) |

   - 活三：

     |                     第一种情况                      |                     第二种情况                      |
     | :-------------------------------------------------: | :-------------------------------------------------: |
     | ![1679045514425](AI五子棋.assets/1679045514425.png) | ![1679045541014](AI五子棋.assets/1679045541014.png) |

   - 死三：

     |                     第一种情况                      |                     第二种情况                      |
     | :-------------------------------------------------: | :-------------------------------------------------: |
     | ![1679045623717](AI五子棋.assets/1679045623717.png) | ![1679045585865](AI五子棋.assets/1679045585865.png) |

   - 活四

     |                     第一种情况                      |                     第二种情况                      |
     | :-------------------------------------------------: | :-------------------------------------------------: |
     | ![1679045685045](AI五子棋.assets/1679045685045.png) | ![1679045831936](AI五子棋.assets/1679045831936.png) |

   - 死四

     |                     第一种情况                      |                     第二种情况                      |
     | :-------------------------------------------------: | :-------------------------------------------------: |
     | ![1679045735893](AI五子棋.assets/1679045735893.png) | ![1679045997723](AI五子棋.assets/1679045997723.png) |

   - 连五（获胜）

     |                     第一种情况                      |                                                     |
     | :-------------------------------------------------: | :-------------------------------------------------: |
     | ![1679045779792](AI五子棋.assets/1679045779792.png) | ![1679046022817](AI五子棋.assets/1679046022817.png) |
...
2. 然后在Chess.h中加入如下代码：
   ...
   ![1679207407978](AI五子棋.assets/1679207407978.png)
...
5. 将Chess.cpp中的Chess::getGradeSize函数和两个Chess::getChessData函数进行如下修改：
   ...
   ![1679208498430](AI五子棋.assets/1679208498430.png)

6. 然后测试一下，发现可以正常下棋了，而且智力还不错。读者可以根据自己的经验调整价值评分的赋值，从而让AI有更高的智力：

   ![1679238301420](AI五子棋.assets/1679238301420.png)
...
1. 上面对胜负进行处理的过程是我们胜负判定实现的一个基本框架，其核心部分是checkWin函数，也就是我们如何判断当然谁赢谁输。我们可以这样想：对于某一个落子位置，我们要判断其八个方向是否连成五子，但是每次判断我们都可以同时根据偏移的落子位置，将其反方向是否连成五子进行判断，所以只需要判断四个大方向，八个小方向即可。假设我们首先判断水平方向，如下图所示：
   ...
   ![1679286782119](AI五子棋.assets/1679286782119.png)
...
2. 然后在Chess.cpp中的Chess::updateGameMap函数中加入如下代码：
   ...
   ![1679291189919](AI五子棋.assets/1679291189919.png)
...
4. 写完之后我们可以测试一下：
   ...
   - 黑棋（棋手）：
     ...
     - 黑棋（棋手）胜的棋面：
       ...
       ![1679397448727](AI五子棋.assets/1679397448727.png)

     - 黑棋（棋手）胜的判定：

       ![1679305975538](AI五子棋.assets/1679305975538.png)

   - 白棋（AI）：

     - 白棋（AI）胜的棋面：

       ![1679397723555](AI五子棋.assets/1679397723555.png)

     - 白棋（AI）胜的判定：

       ![1679305733643](AI五子棋.assets/1679305733643.png)
